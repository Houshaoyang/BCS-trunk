...
#define NWS_PADDING_BYTE_VALUE              0xCCU
...
typedef struct
{
  ...
  U8 uSFDL_THRESHOLD; /* CANFD SF LOW TYPE THRESHOLD . */
}NWS_MSG_TX_t;
...
#define REQ_SEED_03                 0x03U /* requestSeed 0x03 */
#define SEND_KEY_04                 0x04U /* sendKey 0x04 */
#define REQ_SEED_0x21n              0x21U /* requestSeed 0x21 */
#define SEND_KEY_0x22n              0x22U /* sendKey 0x22 */
#define REQ_SEED_01                 0x01U /* requestSeed 0x01 */
#define SEND_KEY_02                 0x02U /* sendKey 0x02 */
...
#define HANDLE_NORMAL_MSG           0x01U /* handle normal message */
#define HANDLE_NM_MSG               0x02U /* handle nm message */
#define HANDLE_ALL_MSG              0x03U /* handle all message */
...
#define CANFD_SFLEN_OFFSET          (1)
#define CANFD_SFLEN_LOW             (8)
#define CANFD_SFLEN_HIGH            (64)
#define CANFD_SFLEN_CPY_OFFSET      (7)
